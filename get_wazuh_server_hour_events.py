...
# Import configuration from secret_tokens.py
try:
    from access_tokens import (
        HOST, INDEX, OS_USERNAME, OS_PASSWORD, 
        SCROLL_TIMEOUT, BATCH_SIZE, IGNORE_RULE_IDS, 
        IGNORE_RULE_GROUPS, LOG_FILE,
        MIN_RULE_LEVEL, MAX_RULE_LEVEL
    )
except ImportError:
    ...
    try:
        ...
        query = {
            ...
            "query": {
                "bool": {
                    "must": [
                        {"range": {"rule.level": {"gte": MIN_RULE_LEVEL, "lte": MAX_RULE_LEVEL}}},
                        {"range": {
                            "@timestamp": {
...
def main():
    ...
    try:
        ...
        try:
            ...
            print(f"Events amount until filtration: {count_before}")
